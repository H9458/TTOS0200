    ...
    class Program
    {
        static void LueOhjastajatVer2()
        {
            try
            {
                ...
                string[] rivit = System.IO.File.ReadAllLines(@"D:\H9458\Olio-ohjelmointi\tilasto2017.csv");
                Ohjastaja kuski;
                ...
                for (int i = 1; i < lkm; i++)
                {
                    ...
                    //tietueita on kahdenlaisia: V1: etunimi+sukunimi V2: etunimi+toinennimi+sukunimi
        ...
        static void LueOhjastajatVer1()
        {
            try
            {
                ...
                int counter = 1;
                string line;
                System.IO.StreamReader stream = new System.IO.StreamReader(@"D:\H9458\Olio-ohjelmointi\tilasto2017.txt");
